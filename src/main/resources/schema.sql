...
CREATE TABLE IF NOT EXISTS FEED (
  ...
  film_id INTEGER REFERENCES FILMS(id) ON DELETE CASCADE ON UPDATE CASCADE,
  review_id INTEGER REFERENCES REVIEWS(id) ON DELETE CASCADE ON UPDATE CASCADE,
  friend_id INTEGER REFERENCES USERS(id) ON DELETE CASCADE ON UPDATE CASCADE,
  user_id INTEGER NOT NULL REFERENCES USERS(id) ON DELETE CASCADE ON UPDATE CASCADE,
  event_type_id INTEGER NOT NULL REFERENCES event_type(id) ON DELETE CASCADE ON UPDATE CASCADE,
  operation_id INTEGER NOT NULL REFERENCES operation_type(id) ON DELETE CASCADE ON UPDATE CASCADE
);