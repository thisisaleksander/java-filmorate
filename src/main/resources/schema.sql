DROP TABLE IF EXISTS EVENT_TYPE, OPERATION_TYPE, FEED, REVIEW_DISLIKES, REVIEW_LIKES, REVIEWS,
FILM_DIRECTOR, DIRECTORS, FILM_GENRE, FILM_MPA, LIKES, FRIENDS, MPA, GENRES, FILMS, USERS, STATUSES;
